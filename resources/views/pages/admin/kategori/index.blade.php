                ...
                <table class="table align-items-center table-flush" id="pengaduanTable">
                  ...
                  <tbody class="list">
                      ...
                      <tr>
                        ...
                        <td><span class="text-sm">{{ $kat->nama_kategori}}</span></td>
                        <td style="width: 100px;">
                            <a href="{{ route('kategori.edit', $kat->id_kategori)}}" class="btn btn-sm btn-warning">Edit</a>
                            <a href="#" data-id_kategori="{{ $kat->id_kategori }}" class="btn btn-sm btn-danger kategoriDelete">Hapus</a>
                        </td>
                      </tr>
    ...
    $(document).on('click', '.kategoriDelete', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "DELETE",
                    url: '{{ route('kategori.destroy', 'id_kategori') }}',
                    data: {
                        "_token": "{{ csrf_token() }}",
